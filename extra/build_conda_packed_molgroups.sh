...
$bindir/python -m pip install --no-input --no-compile git+https://github.com/reflectometry/refl1d@demo_summerschool_2024
...
$bindir/python -m pip install --no-input --no-compile git+https://github.com/sasview/sasdata
$bindir/python -m pip install --no-input --no-compile git+https://github.com/criosx/molgroups
