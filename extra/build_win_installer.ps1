...
& "build\$APP_PATH\Scripts\pip.exe" install --no-warn-script-location numpy==1.19.3
& "build\$APP_PATH\Scripts\pip.exe" install --no-warn-script-location git+https://github.com/bumps/bumps
